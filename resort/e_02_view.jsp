	...
	<div>
		...
		<table width=540>
			...
			<tr>
				...
				<td><input type=button value="수정" 	OnClick=location.href='e_02_update.jsp?key=<%=id%>'></td>
				<td><input type=button value="삭제" 	OnClick=location.href='e_02_delete.jsp?key=<%=id%>'></td>
				<td><input type=button value="댓글" OnClick=location.href='e_02_reinsert.jsp?key=<%=id%>'></td>
			</tr>
		</table>
	</div>
	</div>
