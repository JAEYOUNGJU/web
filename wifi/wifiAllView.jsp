...
<html>
	...
	<body link=#000000>
		...
		<%
			...
			QueryTxt2 = String.format(" select count(*) from wifi;");
			...
			QueryTxt = String.format(" select * from wifi limit "+ startpage +", "+ccnt+";");
		...
		<table border = 1 cellspacing = 1>
			<tr>
				...
				<td width = 150> <p align = center> 위도 </p></td>
				<td width = 150> <p align = center> 경도 </p></td>
				<td width = 150> <p align = center> 현재 지점과 거리 </p></td>
			</tr>
		<%
			...
			if(inpagemove>=((total/100)*10 + 1)){
				...
				out.print("<tr><td width = 1010 align = center><b><a href = 'wifiAllView.jsp?from="+(inpagemove-firstpage)+"&cnt=10&pagemove="+(inpagemove-10)+"'> &lt&lt  </a></b>");		
				for (int i = inpagemove; i < inpagemove + pageprintnum; i++) {
					out.print("<b><a href = 'wifiAllView.jsp?from="+i+"&cnt=10&pagemove="+(inpagemove)+"'> "+i+" </a></b>");			
				}
				out.print("<b><a href = 'wifiAllView.jsp?from="+(inpagemove+lastpage)+"&cnt=10&pagemove="+(inpagemove+lastpage)+"'> &gt&gt </a></b>");
