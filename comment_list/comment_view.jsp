...
<%
	...
	String viewcnt = rset.getString(3); //조회수
	String today = new java.text.SimpleDateFormat("yyyy-MM-dd").format(new java.util.Date());
	String content = rset.getString(5); //내용
	String rootid = rset.getString(6); //원글
	String relevel = rset.getString(7); //댓글수준
	String recnt = rset.getString(8); //댓글 내 순서
...
<tr>
<td><b>조회수</b></td>
<td width=480 colspan=3 align=left><input type='hidden' name="click" value=<%=viewcnt%>><%=viewcnt%></td>
</tr>

<tr>
<td><b>내용</b></td>
<td width=480 colspan=3 align=left><input type='hidden' name="click" value=<%=content%>><%=content%></td>
</tr>

<tr>
<td><b>원글</b></td>
<td width=480 colspan=3 align=left><input type='hidden' name="click" value=<%=rootid%>><%=rootid%></td>
</tr>

<tr>
<td><b>댓글수준</b></td>
<td width=480 colspan=3 align=left><input type='hidden' name="click" value=<%=relevel%>><%=relevel%>
<center>댓글내 순서<input type='number' name="recnt" maxlength="1" value=<%=recnt%> readonly style='font-size:9pt; width: 2px margin:3px; padding: 2px;  border: 1px solid #ccc;'>
</center></tr>
...
<table width=540 class="btn float-right">
...
<tr>
		...
		<td><input type=button value="댓글" OnClick="location.href='gongji_reinsert.jsp?key=<%=id%>'"></td>
</tr>
</table>
